 ...
 * Starting with creating an blank array, the block of code within the loop will
 ...
 * status for everyother item to indicate whether the class will be running this 
 * year. For example:
 ...
 * (lesson with the numeric value) and predefined status (which we set up in the
 * previous step).
