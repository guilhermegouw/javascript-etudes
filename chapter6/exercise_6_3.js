 ...
 * Test your function by invoking it with different operators and no operator 
 * specified.
 * 
 ...
 * value within its parameters. Use those values with a condition to check if 
 * the operator is + or -, and add or subtract the values accordingly (remember 
 * if not presented with a valid operator, the function should default to 
 * addition).
 * 
